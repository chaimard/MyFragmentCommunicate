...
public class ReceiverFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button receiverBtn = (Button) v.findViewById(R.id.receiverBtn);
        receiverBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment senderFragment = getActivity().getSupportFragmentManager().findFragmentById(R.id.senderFragment);
                Button senderBtn = (Button) senderFragment.getView().findViewById(R.id.senderBtn);
                senderBtn.setText("Msg from Receiver Frg");
