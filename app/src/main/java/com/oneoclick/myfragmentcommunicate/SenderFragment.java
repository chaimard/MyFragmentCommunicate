...
public class SenderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button senderBtn = (Button) v.findViewById(R.id.senderBtn);
        senderBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment receiverFragment = getActivity().getSupportFragmentManager().findFragmentById(R.id.receiverFragment);
                Button receiverBtn = (Button) receiverFragment.getView().findViewById(R.id.receiverBtn);
                receiverBtn.setText("Msg from Sender Frg");
